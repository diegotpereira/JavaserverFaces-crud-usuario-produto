...
public class BuscarUsuarioPorIdDao {
	...
	public Usuario buscarUsuarioPorId(long usuarioId) {
		...
		String SQL = "SELECT USUARIOS.ID AS USUARIOID, USUARIOS.NOME, USUARIOS.ADMIN, USUARIOS.USERNAME, USUARIOS.SALT, USUARIOS.PASSWORD FROM USUARIOS WHERE USUARIOS.ID = ? ";
